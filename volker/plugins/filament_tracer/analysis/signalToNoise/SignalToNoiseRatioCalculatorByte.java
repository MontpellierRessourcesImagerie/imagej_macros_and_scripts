 ...
 **/
public class SignalToNoiseRatioCalculatorByte extends
		SignalToNoiseRatioCalculator {

	public SignalToNoiseRatioCalculatorByte(ImagePlus image) {
		super(image);
	}

	protected float valueAt(int index) {
		return (((byte[])(data))[index])&0xff;
	}

	protected float valueAt(int x, int y) {
		return ((byte[])data)[y*width+x]&0xff;
	}
