 ...
 */
public class MedianThresholdSignalToNoiseEstimatorByte extends
		MedianThresholdSignalToNoiseEstimator {

	public MedianThresholdSignalToNoiseEstimatorByte(ImagePlus image, int radiusX, int radiusY) {
