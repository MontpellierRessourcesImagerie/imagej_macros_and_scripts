...
<img align='right' src="https://github.com/user-attachments/assets/718ee44f-76a5-4eb2-9c6e-2e8bd7276e48" height='100'/> The tool allows to measure the area of the invading spheroïd in a 3D cell invasion assay. It can also count and measure the area of the nuclei within the speroïd.  
...
#### [Spine Analyzer](https://github.com/MontpellierRessourcesImagerie/imagej_macros_and_scripts/wiki/Spine-Analyzer)

<img align='right' src="https://github.com/MontpellierRessourcesImagerie/imagej_macros_and_scripts/assets/7602420/4a784563-f0e1-4e0b-ab66-df49d281ef4b" height='100'/> The tools allow to semi-automatically segment dendritic spines in 3D+t images and to measure their volumes and the intensities of the signal within in different channels over time.
...
<img align='right' src="https://github.com/user-attachments/assets/c3b8cdd8-3e16-45aa-8267-068431f409d2" height='100'/> The tool corrects a constant drift in a time-series. When the objects in the images move, drift-correction can be difficult. Here a second channel is provided, in which there are no moving objects, however in order to be able to acquire images fast enough, for the second channel only the images of the first and the last frame are taken. 
...
<img align='right' src="https://github.com/user-attachments/assets/3819a8f7-307e-45ba-925a-e10c0327a52b" height='100'/> Allows to segment a batch of mitotic spindles and extract measurements from a microtubules staining.
